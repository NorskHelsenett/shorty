...
var Dropdown = React21.memo(React21.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React21.useState(false), _React$useState2 = _slicedToArray7(_React$useState, 2), focusedState = _React$useState2[0], setFocusedState = _React$useState2[1];
  var _React$useState3 = React21.useState(-1), _React$useState4 = _slicedToArray7(_React$useState3, 2), focusedOptionIndex = _React$useState4[0], setFocusedOptionIndex = _React$useState4[1];
  var _React$useState5 = React21.useState(false), _React$useState6 = _slicedToArray7(_React$useState5, 2), overlayVisibleState = _React$useState6[0], setOverlayVisibleState = _React$useState6[1];
